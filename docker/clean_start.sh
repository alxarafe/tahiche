...
# Adjusted paths to match Tahiche structure
...
echo "Stopping and removing Tahiche containers..."
...
docker exec -it tahiche_php composer install
...
docker exec -it tahiche_node npm install
...
# Adjusted to the port 8081 we defined for Tahiche
