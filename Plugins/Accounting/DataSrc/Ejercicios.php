...
namespace FacturaScripts\Plugins\Accounting\DataSrc;

use FacturaScripts\Core\Base\AbstractDataSrc;
use FacturaScripts\Plugins\Accounting\Model\Ejercicio;

final class Ejercicios extends AbstractDataSrc
{
    protected static function getCacheKey(): string
    {
        return 'model-Ejercicio-list';
    }
