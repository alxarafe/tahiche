...
use FacturaScripts\Dinamic\Model\Base\EmailAndPhonesTrait;
use FacturaScripts\Dinamic\Model\Base\FiscalNumberTrait;
use FacturaScripts\Dinamic\Model\Base\GravatarTrait;
...
class Cliente extends ModelClass
{
    ...
    {
        return Vies::check($this->cifnif ?? '', '', $msg) === 1;
    }
