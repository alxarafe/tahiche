...
use Tahiche\Dinamic\Lib\Calculator;
use Tahiche\Dinamic\Model\Agente;
use Tahiche\Dinamic\Model\Almacen;
use Tahiche\Dinamic\Model\Ciudad;
use Tahiche\Dinamic\Model\Cliente;
use Tahiche\Dinamic\Model\Contacto;
use Tahiche\Dinamic\Model\Cuenta;
use Tahiche\Dinamic\Model\Ejercicio;
use Tahiche\Dinamic\Model\Empresa;
use Tahiche\Dinamic\Model\FacturaCliente;
use Tahiche\Dinamic\Model\FacturaProveedor;
use Tahiche\Dinamic\Model\Impuesto;
use Tahiche\Dinamic\Model\Pais;
use Tahiche\Dinamic\Model\Producto;
use Tahiche\Dinamic\Model\Proveedor;
use Tahiche\Dinamic\Model\Provincia;
use Tahiche\Dinamic\Model\Serie;
use Tahiche\Dinamic\Model\User;
use Tahiche\Dinamic\Model\Variante;
...
trait RandomDataTrait
{
    ...
    protected function getRandomUser(): User
    {
        ...
        $user->email = $user->nick . '@tahiche.com';
