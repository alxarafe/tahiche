 ...
 * Copyright (C) 2023-2025 Tahiche Team <tahiche@alxarafe.com>
 *
...
final class ValidatorTest extends TestCase
{
    ...
    {
        $this->assertTrue(Validator::email('tahiche@alxarafe.com'));
        $this->assertFalse(Validator::email('carlos'));
        $this->assertFalse(Validator::email('carlos@'));
        $this->assertFalse(Validator::email('@tahiche.com'));
    }
    ...
    {
        $this->assertTrue(Validator::url('http://tahiche.com'));
        $this->assertTrue(Validator::url('https://tahiche.com'));
        $this->assertTrue(Validator::url('ftp://tahiche.com'));
        $this->assertTrue(Validator::url('ftps://tahiche.com'));

        $this->assertTrue(Validator::url('www.tahiche.com'));
        $this->assertFalse(Validator::url('www.tahiche.com', true));
