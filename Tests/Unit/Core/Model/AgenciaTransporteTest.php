...
use Tahiche\Core\Model\AgenciaTransporte;
...
final class AgenciaTransporteTest extends TestCase
{
    ...
    public function testGoodWeb(): void
    {
        ...
        $agency->codtrans = 'Test';
        $agency->nombre = 'Test Agency';
        $agency->web = 'https://www.tahiche.com';
    ...
    public function testLoadFromData(): void
    {
        ...
        $this->assertEquals('https://www.tahiche.com', $agency->web, 'agency-cant-load-web');
        ...
        $agency->loadFromData([
            ...
            'web' => 'https://www.tahiche.com/test'
        ]);
        ...
        $this->assertEquals('https://www.tahiche.com/test', $agency->web, 'agency-cant-load-web-2');
    }
    ...
    public function testGetOriginal(): void
    {
        ...
        $this->assertEquals('https://www.tahiche.com', $agency2->getOriginal('web'), 'agency-getoriginal-wrong-web');
        ...
        $this->assertEquals('https://www.tahiche.com', $agency2->getOriginal('web'), 'agency-getoriginal-after-modify-web');
