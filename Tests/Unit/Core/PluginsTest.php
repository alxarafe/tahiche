...
use Tahiche\Core\Internal\Plugin;
...
final class PluginsTest extends TestCase
{
    ...
    public function testPlugin2(): void
    {
        ...
        $this->assertFileExists(Plugins::folder() . '/TestPlugin2/tahiche.ini');
    ...
    public function testUpdatePlugin2(): void
    {
        ...
        // añadimos test = 1 al final del archivo tahiche.ini
        $iniPath = Plugins::folder() . '/TestPlugin2/tahiche.ini';
        ...
        // comprobamos que el archivo tahiche.ini se ha restaurado
    ...
    public function testUpdateEnabledPlugin2(): void
    {
        ...
        // añadimos test = 2 al final del archivo tahiche.ini
        $iniPath = Plugins::folder() . '/TestPlugin2/tahiche.ini';
